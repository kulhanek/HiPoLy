...
CSimpleMutex::CSimpleMutex(void)
{
    SecretImpl = NULL;
...
#ifdef HAVE_PTHREAD_H
    SecretImpl = new CSimpleMutexPThread;
#endif
}
...
bool CSimpleMutex::Lock(void)
{
    if( SecretImpl == NULL ) RUNTIME_ERROR("SecretImpl is NULL");
    return( SecretImpl->Lock() );
}

//------------------------------------------------------------------------------

bool CSimpleMutex::Unlock(void)
{
    if( SecretImpl == NULL ) RUNTIME_ERROR("SecretImpl is NULL");
    return( SecretImpl->Unlock() );
}
